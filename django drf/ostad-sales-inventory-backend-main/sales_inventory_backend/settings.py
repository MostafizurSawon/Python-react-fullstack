...
SECRET_KEY = "django-insecure-in)+19w7^a-e2*adfbq6^!kar-xg80l*6ss=t$k=wh$&x-&k6$"
...
ROOT_URLCONF = "sales_inventory_backend.urls"
...
WSGI_APPLICATION = "sales_inventory_backend.wsgi.application"
