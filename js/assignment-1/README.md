# Interior Freaks
Live site: https://interior-freaks.netlify.app/

## Assignment 01 | Batch 01 | 2024 | HTML, CSS & JS

### Overview

In this assignment, the task is to create a website following the design of the `pdf` file and make it interactive. Use the knowledge you've gained throughout the modules. All the resources and the design is given. Simply implement the design and make it interactive.
